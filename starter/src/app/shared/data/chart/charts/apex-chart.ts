...
const secondary = localStorage.getItem('secondary_color') || '#48A3D7';
...
export const areaSpaline: ChartOptions | any = {
  chart: {
    height: 350,
    type: "area",
    toolbar: {
...
export const barChart: ChartOptions | any = {
  chart: {
    height: 350,
    type: "bar",
    toolbar: {
...
export const dountChart: ChartOptions | any = {
  chart: {
    width: 380,
    type: "donut",
  },
...
export const candelsStickChart: ChartOptions | any = {
  chart: {
    height: 350,
    type: "candlestick",
    toolbar: {
